...
export const metadata: Metadata = {
  title: 'Features | Wrong Question Notebook',
  description:
    'Discover everything Wrong Question Notebook can do — rich math editing, AI problem extraction, smart review sessions, analytics, and more.',
  alternates: {
        ...
        <FeatureShowcase>
          ...
          <section className="px-6 py-16 lg:py-24">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              <div
                className="opacity-0 inline-flex items-center gap-2 rounded-full bg-amber-100/80 dark:bg-amber-900/30 px-4 py-1.5 text-sm font-medium text-amber-800 dark:text-amber-300 border border-amber-200/50 dark:border-amber-800/40"
                data-animate="features-fade-in-up"
              >
                <Sparkles className="w-3.5 h-3.5" />
                Everything WQN can do
              </div>

              <h1
                className="opacity-0 landing-hero-title"
                data-animate="features-fade-in-up"
              >
                Powerful tools for{' '}
                <span className="text-gradient-warm">smarter studying</span>
              </h1>
              ...
              <p
                ...
                data-animate="features-fade-in-up"
              >
                From rich math equations to AI-powered problem extraction,
                discover everything that makes Wrong Question Notebook the best
